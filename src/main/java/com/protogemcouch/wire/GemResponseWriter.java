...
public final class GemResponseWriter {
    ...
    // Same recursive supported-value rules + deep copy the decode path uses (NestedValueSupport),
    // so the wire re-encode here accepts exactly the maps ValueDecoding decoded structurally.
